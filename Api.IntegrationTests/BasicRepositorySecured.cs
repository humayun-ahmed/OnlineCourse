...
namespace OnlineCourse.Api.IntegrationTests
{
        ...
        where T : ITestStartup
    {
        ...
        /// </summary>
        public IRepositoryOnlineCourse Repository { get; set; }
        ...
        public void BeforeTestRun()
        {
            ...
            this.Repository = TestStartup.BootstrapperWebApi.DependencyResolver.BeginScope().Resolve<IRepositoryOnlineCourse>();
        ...
        */
        ...
        private void BasicDataCleanup()
        {
            ...
            var dbConnectionFactoryCustom = (DbConnectionFactoryTest<OnlineCourseContext>)TestStartup.BootstrapperWebApi.DependencyResolver.Resolve<IDbConnectionFactoryCustom<OnlineCourseContext>>();
