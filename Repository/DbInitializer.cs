...
namespace OnlineCourse.Repository
{
    ...
    ///     The bb db initializer.
    /// </summary>
    public class DbInitializer : DbInitializerBase<OnlineCourseContext, Configuration>
    {
        ...
        /// The context.
        /// </param>
        public override void Seed(OnlineCourseContext context)
        {
